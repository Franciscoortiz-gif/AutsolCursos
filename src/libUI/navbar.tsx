...
export default function Navbarlis() {
  ...
  return (
    <Navbar className="border-none mx-auto w-screen px-4 py-2 lg:px-8 lg:py-4 animate-fade animate-duration-1000 animate-ease-in-out animate-alternate">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900 animate-fade-up animate-once animate-duration-1000">
        <Typography
          as="a"
          href="/"
        ...
        <div className="flex items-center gap-x-1 animate-fade animate-duration-1000 animate-ease-in-out animate-alternate">
          <Button size="sm" className="hidden lg:inline-block animate-fade animate-duration-1000 animate-ease-in-out animate-alternate">
