...
function Store() {
  return (
   <>
    <div className="h-[150vh] lg:min-h-[90vh] lg:max-h-[500vh] lg:h-auto bg-[#1869E2] flex justify-center items-center">
        <div className="grid grid-flow-col grid-cols-1 grid-rows-2 lg:grid-cols-3 lg:grid-rows-1 lg:gap-10 gap-4">
          <div className="flex flex-col justify-start ml-4 lg:ml-64 mr-4 col-span-2">
            ...
            <div className="text-left font-medium mb-22"><label className="text-[28px] line lg:text-7xl text-left lg:leading-20">Cursos practicos de marcas <br /> como Delta, Wago, AllenBradley y Siemes con instructores altamente calificados.</label></div>
            <div className="flex justify-start mb-10"><input type="text" placeholder="Buscar" className="w-72 lg:w-3xl h-11 lg:h-16 rounded-[5px] p-3 lg:text-2xl bg-amber-50 text-black border-none outline-none" />
          ...
          <div className="w-full h-full">
            <div className="flex flex-col justify-center mt-3 mb-3 ml-4 lg:ml-0 items-center w-full h-full ">
              <div className="flex flex-row lg:justify-center lg:items-center justify-start lg:mb-[40px]">
              ...
              <div className="w-full flex justify-center items-center ">
                <Card className="w-2/3 lg:w-1/2 border-none outline-none">
                <CardContent>
